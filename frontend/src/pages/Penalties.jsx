...
// Data comes from GET /api/penalties (real backend).
//
// Automatic penalty creation (missed task, low focus session,
// broken streak) now runs server-side — see the detection rules
// at the top of penalty.controller.js. This page just reads
// whatever exists and lets the student mark things as redeemed.
// ---------------------------------------------------------
...
export default function Penalties() {
  ...
  const { events, strikeLevel, strikeCount, totalXpDeducted, currentStreak, redemptionChallenges } = data;
