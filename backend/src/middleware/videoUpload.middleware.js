...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const courseId = String(req.params.courseId || "unknown").replace(/[^a-zA-Z0-9_-]/g, "");
    const folder = path.join(UPLOAD_ROOT, "course-videos", courseId);
...
module.exports = { uploadSingleVideo, MAX_VIDEO_BYTES, VIDEO_MIMES };
