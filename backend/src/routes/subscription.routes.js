...
router.post("/verify", requireAuth, requireStudentOrParent, requireFeature("payments"), paymentLimiter, verifySubscriptionPayment);
router.post("/fail", requireAuth, requireStudentOrParent, requireFeature("payments"), paymentLimiter, markSubscriptionPaymentFailed);
